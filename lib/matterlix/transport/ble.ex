defmodule Matterlix.Transport.BLE do
  @moduledoc """
  CHIPoBLE transport GenServer.

  Manages the BLE connection lifecycle for Matter commissioning. Delegates
  fragmentation/reassembly to `Matterlix.Transport.BTP`. Communicates with
  ...
  `Matterlix.Transport.BLE.Adapter`.
  ...
  ## Example
      ...
      Matterlix.Transport.BLE.send(ble, response_data)
  """

  use GenServer

  alias Matterlix.Transport.BTP
  ...
  - `:adapter` — module implementing `Matterlix.Transport.BLE.Adapter`
