defmodule MatterEx.Cluster.ColorControl do
  @moduledoc """
  ...
  use MatterEx.Cluster, id: 0x0300, name: :color_control
  ...
  def handle_command(:move_to_hue, params, state) do
    state =
      state |> set_attribute(:current_hue, params[:hue] || 0) |> set_attribute(:color_mode, 0)
  ...
  def handle_command(:move_to_saturation, params, state) do
    state =
      state
      |> set_attribute(:current_saturation, params[:saturation] || 0)
      |> set_attribute(:color_mode, 0)
