defmodule MatterEx.Cluster.FanControl do
  @moduledoc """
  ...
  use MatterEx.Cluster, id: 0x0202, name: :fan_control

  # FanMode: 0=Off, 1=Low, 2=Medium, 3=High, 4=On, 5=Auto, 6=Smart
  attribute(0x0000, :fan_mode, :enum8,
    default: 0,
    writable: true,
  ...
  attribute(0x0001, :fan_mode_sequence, :enum8,
    default: 2,
    writable: true,
