defmodule MatterEx.Cluster.BasicInformation do
  ...
  attribute(0x000C, :part_number, :string, default: "matter-ex-example")
  attribute(0x000D, :product_url, :string, default: "https://example.com/matter-ex")
  attribute(0x000E, :product_label, :string, default: "MatterEx Example")
  attribute(0x000F, :serial_number, :string, default: "matter-ex-example-001")
  attribute(0x0010, :local_config_disabled, :boolean, default: false)
  attribute(0x0012, :unique_id, :string, default: "matter-ex-example-001")
