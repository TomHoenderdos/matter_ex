defmodule MatterEx.Cluster.WindowCovering do
  @moduledoc """
  ...
  use MatterEx.Cluster, id: 0x0102, name: :window_covering
  ...
  attribute(0x000E, :current_position_lift_percent_100ths, :uint16,
    default: 0,
    writable: true,
    min: 0,
    max: 10000
  ...
  attribute(0x000F, :current_position_tilt_percent_100ths, :uint16,
    default: 0,
    writable: true,
    min: 0,
    max: 10000
