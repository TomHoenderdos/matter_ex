defmodule MatterEx.Cluster.Scenes do
  @moduledoc """
  ...
  use MatterEx.Cluster, id: 0x0005, name: :scenes
  ...
  command(
    0x00,
    :add_scene,
    [group_id: :uint16, scene_id: :uint8, transition_time: :uint16, scene_name: :string],
    response_id: 0x00
  )
  ...
  def handle_command(:store_scene, params, state) do
    ...
    state =
      state
      |> set_attribute(:current_scene, scene_id)
      |> set_attribute(:current_group, group_id)
      |> set_attribute(:scene_valid, true)
