...
defmodule MatterEx.Cluster.PM25ConcentrationMeasurement do
  ...
  use MatterEx.Cluster.ConcentrationMeasurement,
    cluster_id: 0x042A,
    cluster_name: :pm25_concentration_measurement
end
...
defmodule MatterEx.Cluster.PM10ConcentrationMeasurement do
  ...
  use MatterEx.Cluster.ConcentrationMeasurement,
    cluster_id: 0x042D,
    cluster_name: :pm10_concentration_measurement
end
...
defmodule MatterEx.Cluster.CarbonDioxideConcentrationMeasurement do
  ...
  use MatterEx.Cluster.ConcentrationMeasurement,
    cluster_id: 0x040D,
    cluster_name: :carbon_dioxide_concentration_measurement
end
...
defmodule MatterEx.Cluster.TotalVolatileOrganicCompoundsConcentrationMeasurement do
  ...
  use MatterEx.Cluster.ConcentrationMeasurement,
    cluster_id: 0x042E,
    cluster_name: :tvoc_concentration_measurement
end
