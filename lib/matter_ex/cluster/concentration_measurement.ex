defmodule MatterEx.Cluster.ConcentrationMeasurement do
  @moduledoc """
  ...
  defmacro __using__(opts) do
    ...
    quote do
      use MatterEx.Cluster, id: unquote(cluster_id), name: unquote(cluster_name)
...
defmodule MatterEx.Cluster.PM25ConcentrationMeasurement do
  @moduledoc "PM2.5 Concentration Measurement cluster (0x042A)."
  use MatterEx.Cluster.ConcentrationMeasurement, cluster_id: 0x042A, cluster_name: :pm25_concentration_measurement
end

defmodule MatterEx.Cluster.PM10ConcentrationMeasurement do
  @moduledoc "PM10 Concentration Measurement cluster (0x042D)."
  use MatterEx.Cluster.ConcentrationMeasurement, cluster_id: 0x042D, cluster_name: :pm10_concentration_measurement
end

defmodule MatterEx.Cluster.CarbonDioxideConcentrationMeasurement do
  @moduledoc "Carbon Dioxide Concentration Measurement cluster (0x040D)."
  use MatterEx.Cluster.ConcentrationMeasurement, cluster_id: 0x040D, cluster_name: :carbon_dioxide_concentration_measurement
end

defmodule MatterEx.Cluster.TotalVolatileOrganicCompoundsConcentrationMeasurement do
  @moduledoc "TVOC Concentration Measurement cluster (0x042E)."
  use MatterEx.Cluster.ConcentrationMeasurement, cluster_id: 0x042E, cluster_name: :tvoc_concentration_measurement
end
